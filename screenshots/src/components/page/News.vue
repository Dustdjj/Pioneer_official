...
import {postRequest,postJsonRequest} from '../../main'
    export default {
        ...
        methods: {
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                postRequest("http://localhost:8080/public/getAllNews",{
                    page:this.cur_page
                }).then((res)=>{
                    console.log(res);
             ...
             search() {
                this.is_search = true;
                postRequest("http://localhost:8080/public/getNewsByName",{
            ...
            saveEdit() {
                ...
                postJsonRequest("http://localhost:8080/public/updateNews",this.form).then((res)=>{
                    console.log(res);
            ...
            deleteRow(){
               ...
               this.tableData.splice(this.idx, 1);
                 postRequest("http://localhost:8080/public/deleteNewsById",{
