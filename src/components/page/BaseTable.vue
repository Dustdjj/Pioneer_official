...
import {postRequest,postJsonRequest} from '../../main'
    export default {
        ...
        methods: {
            ...
            search() {
                this.is_search = true;
                postRequest("http://houtai.dota4.cn/public/selectProductByName",{
            ...
            saveEdit() {
                ...
                postJsonRequest("http://houtai.dota4.cn/public/updateProductById",this.form).then((res)=>{
                    console.log(res);
            ...
            deleteRow(){
                ...
                this.tableData.splice(this.idx, 1);
                 postRequest("http://houtai.dota4.cn/public/deleteProductById",{
